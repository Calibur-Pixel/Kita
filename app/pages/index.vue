  ...
  <div class="home-container">
    ...
    >
      <div class="d-flex ga-4 fill-height flex-column justify-center align-center text-white float-in-up">
        ...
        <h4 class="text-h5 subheading text-shadow">
          Minecraft 公益服务器
        </h4>
      </div>
    </VParallax>
    ...
    <div class="second-block d-flex flex-shrink-0 flex-column flex-wrap justify-center align-center pa-8">
      <div class="line d-flex flex-shrink-0 flex-wrap justify-center align-center">
        <HomeFeature icon="mdi-memory" title="性能">
          高性能的独立服务器<br>由Paper服务端驱动
        </HomeFeature>
        <HomeFeature icon="mdi-pinwheel" title="可爱">
          倡导萌与可爱<br>Kawaii的MC社区
        </HomeFeature>
        <HomeFeature icon="mdi-cog" title="热忱">
          由热爱驱动<br>勤奋的更新与修复
        </HomeFeature>
      </div>
      <div class="line d-flex flex-shrink-0 flex-wrap justify-center align-center">
        <HomeFeature icon="mdi-heart" title="樱花区">
          经典插件生存服<br>完善的菜单、商店、社区系统
        </HomeFeature>
      </div>
    </div>

    <VParallax
      class="third-block" :height="320"
      src="https://i0.hdslb.com/bfs/album/a340523de38f5cf7b393cb62b15c3dd0d1960d71.png@2560w.webp"
    >
      <div class="pa-8 d-flex fill-height justify-space-between text-white flex-column flex-sm-row">
        ...
        <div class="d-flex flex-column align-start align-sm-end">
          <VBtn prepend-icon="mdi-content-copy" color="primary" @click="updateClipboard(); snackbar = true">
            复制连接地址
          </VBtn>
          <p class="text-shadow mt-1">
            {{ mcLink }}
          </p>
        </div>
      </div>
